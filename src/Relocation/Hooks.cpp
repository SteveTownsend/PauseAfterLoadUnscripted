...
namespace Hooks {
void Install() { Hook::SetupHook(); }

bool Hook::UpdateInDialogue_Actor(RE::Actor *a_this,
                                  RE::DialogueResponse *a_response,
                                  bool a_unused) {
  std::string actorName;
  if (a_this->GetActorBase() && a_this->GetActorBase()->GetFullNameLength()) {
    actorName = std::string(a_this->GetActorBase()->GetFullName(),
                            a_this->GetActorBase()->GetFullNameLength());
  }
...
bool Hook::UpdateInDialogue_Character(RE::Character *a_this,
                                      RE::DialogueResponse *a_response,
                                      bool a_unused) {
  std::string actorName;
  if (a_this->GetActorBase() && a_this->GetActorBase()->GetFullNameLength()) {
...
bool Hook::UpdateInDialogue_PlayerCharacter(RE::PlayerCharacter *a_this,
                                            RE::DialogueResponse *a_response,
                                            bool a_unused) {
